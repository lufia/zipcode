...
func TestParseSplitted(t *testing.T) {
	...
	expects := []*Entry{
		...
		&Entry{
			...
			OldZip:        "37033",
			Zip:           "3703321",
			Pref:          Name{"群馬県", "ｸﾞﾝﾏｹﾝ"},
			Region:        Name{"吾妻郡東吾妻町", "ｱｶﾞﾂﾏｸﾞﾝﾋｶﾞｼｱｶﾞﾂﾏﾏﾁ"},
			Town:          Name{"泉沢烏帽子「榛名湖畔」", "ｲｽﾞﾐｻﾜｴﾎﾞｼ(ﾊﾙﾅｺﾊﾝ)"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "10429",
			...
			Pref:          Name{"群馬県", "ｸﾞﾝﾏｹﾝ"},
			Region:        Name{"吾妻郡東吾妻町", "ｱｶﾞﾂﾏｸﾞﾝﾋｶﾞｼｱｶﾞﾂﾏﾏﾁ"},
			Town:          Name{"泉沢烏帽子国有林77林班", "ｲｽﾞﾐｻﾜｴﾎﾞｼｺｸﾕｳﾘﾝ77ﾘﾝﾊﾝ"},
			IsPartialTown: true,
		},
	}
...
func TestPraseExpr(t *testing.T) {
	actuals := []string{
		...
		`16207,"93801","9380174","ﾄﾔﾏｹﾝ","ｸﾛﾍﾞｼ","ｳﾅﾂﾞｷﾏﾁｵﾄｻﾞﾜ(1-2､5)","富山県","黒部市","宇奈月町音澤（１〜２、５）",1,0,0,0,0,0`, // 長いので改変
	...
	expects := []*Entry{
		...
		&Entry{
			...
			Zip:           "0613774",
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下782−13番地", "ｶﾜｼﾓ782-13ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5363−7番地", "ｶﾜｼﾓ5363-7ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5363−8番地", "ｶﾜｼﾓ5363-8ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5382−3番地", "ｶﾜｼﾓ5382-3ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5405−4番地", "ｶﾜｼﾓ5405-4ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5407−5番地", "ｶﾜｼﾓ5407-5ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5445−4番地", "ｶﾜｼﾓ5445-4ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "01303",
			...
			Pref:          Name{"北海道", "ﾎｯｶｲﾄﾞｳ"},
			Region:        Name{"石狩郡当別町", "ｲｼｶﾘｸﾞﾝﾄｳﾍﾞﾂﾁｮｳ"},
			Town:          Name{"川下5446−4番地", "ｶﾜｼﾓ5446-4ﾊﾞﾝﾁ"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "16207",
			...
			Zip:           "9380174",
			Pref:          Name{"富山県", "ﾄﾔﾏｹﾝ"},
			Region:        Name{"黒部市", "ｸﾛﾍﾞｼ"},
			Town:          Name{"宇奈月町音澤1", "ｳﾅﾂﾞｷﾏﾁｵﾄｻﾞﾜ1"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "16207",
			...
			Pref:          Name{"富山県", "ﾄﾔﾏｹﾝ"},
			Region:        Name{"黒部市", "ｸﾛﾍﾞｼ"},
			Town:          Name{"宇奈月町音澤2", "ｳﾅﾂﾞｷﾏﾁｵﾄｻﾞﾜ2"},
			IsPartialTown: true,
		},
		&Entry{
			Code:          "16207",
			...
			Pref:          Name{"富山県", "ﾄﾔﾏｹﾝ"},
			Region:        Name{"黒部市", "ｸﾛﾍﾞｼ"},
			Town:          Name{"宇奈月町音澤5", "ｳﾅﾂﾞｷﾏﾁｵﾄｻﾞﾜ5"},
			IsPartialTown: true,
		},
	}
	parseTest(t, actuals, expects, "\n")
